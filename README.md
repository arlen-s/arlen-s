...
Goal        : Create useful and polished projects
```
...
* Creating a clean GitHub portfolio
...
| Interests  | AI Tools · Automation · Product Design |
...
| ----------------- | ---------------------------------- | ----------------------- |
| Portfolio Website | A clean personal portfolio site    | HTML / CSS / JavaScript |
| Web App Demo      | A modern frontend practice project | React / Next.js         |
| AI Tool Demo      | A small AI-powered tool            | Python / API            |
